...
let generate = () => {
  ...
  1 == 1
  pl1.src = "assets/audio/notes/" + arrInterval[0].replace("#", "%23") + ".mp3";
  pl2.src = "assets/audio/notes/" + arrInterval[1].replace("#", "%23") + ".mp3";
}
